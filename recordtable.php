...
<html>
  ...
  <body>
    <div class="topnav">
      <h3>ARROSAGE AUTOMATIQUE HISTORIQUE </h3>
    </div>
    
    <br>
    
    <h3 style="color: #0c6980;">HISTORIQUE TABLE</h3>
    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM esp32_record_sensor ORDER BY date, time';
          foreach ($pdo->query($sql) as $row) {
			...
			echo '<td class="bdr">'. $row['Btn_01'] . '</td>';
            echo '<td class="bdr">'. $row['Btn_02'] . '</td>';
    ...
    <div class="content">
        <div class="cards">
            <div class="card header" style="border-radius: 15px;">
                <button onclick="window.open('home.php', '_blank');"> Home</button>
